...
<div class="sm">
	<div class="container">
		...
		<div class="row">
  			...
  			<div class="span4"><a class="brand" href="#"><img alt="AN LẠC DUYÊN" src="<c:url value="/resources/img/anlacduyen_small.jpg" />"/></a></div>
	...
	<div class="container"> 
		...
		<footer> 
 			<p>&copy; Tu Viện Chơn Như 2026-<%=Calendar.getInstance().get(Calendar.YEAR)%></p> 
		</footer> 
