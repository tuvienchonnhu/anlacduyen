...
<%@page pageEncoding="UTF-8"%>
	  ...
	  <!-- footer -->
		    ...
		    <div id="footer-bottom">
				<div class="container">
				   <div class="row-fluid">
					<div class="span12 text">&copy;&nbsp;<s:message code="label.generic.providedby" /> <a href="http://www.tuvienchonnhu.net" class="footer-href" target="_blank">Tu Viện Chơn Như</div>
				   </div>
				 </div>
		    </div>
            </footer>