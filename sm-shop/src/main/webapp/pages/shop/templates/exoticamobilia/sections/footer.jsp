...
<%@page pageEncoding="UTF-8"%>
      ...
      <footer id="footer">
		...
		<div class="subfooter">
				<div class="container">
				   <div class="row">
					<div class="col-md-6"><sm:storeCopy/>&nbsp;-&nbsp;<s:message code="label.generic.providedby" /> <a href="http://www.tuvienchonnhu.net" class="footer-href" target="_blank">Tu Viện Chơn Như</a></div>
				    <div class="col-md-6">
